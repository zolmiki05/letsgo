<p style="margin:0 0 4px;font-size:.78rem;font-weight:600;color:#92400E;text-transform:uppercase;letter-spacing:.07em">
  <?= e($group['name']) ?> · <?= e(Lang::t('email.event_updated_title')) ?>
</p>
...
<p style="margin:0 0 20px;color:#46567A;font-size:.9375rem;line-height:1.6">
  <?= e(Lang::t('email.event_updated_body', [
